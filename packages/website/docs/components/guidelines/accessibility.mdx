...
import { EuiAspectRatio, EuiTextColor } from '@elastic/eui';
...
<EuiAspectRatio width={16} height={9}>
  <iframe
    width="100%"
    src="https://www.youtube.com/embed/iDXoEe8NkrE?si=jFHwNqZn-EXDU9Iz"
...
<GuideRule type="do" panelPadding="l" text="These are good example of page titles.">
  **Discover - Kibana**
...
<GuideRule
  ...
  text={
    <>
      Although this provides all the context and in a good order, a title is not the place for any extra words.<br />
      <EuiTextColor color="success">
