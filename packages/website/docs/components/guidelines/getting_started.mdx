...
<Tabs groupId="packageManager">
  ...
  <TabItem value="pnpm" label="pnpm">
    ```bash
    pnpm add @elastic/eui @elastic/datemath @emotion/react @emotion/css moment
    ```
  </TabItem>
</Tabs>
...
_Keep an eye out for this language selector that will allow you to view the syntax for either the Sass or CSS-in-JS (Emotion) theming mechanisms._

<Tabs groupId="stylingLanguage">
  <TabItem label="CSS-in-JS" value="cssinjs">
...
### Embedding with `@font-face`[](/docs/guidelines/getting-started#embedding-with-font-face-)
...
## Components, Services and Testing imports[](/docs/guidelines/getting-started#components-services-and-testing-imports)
