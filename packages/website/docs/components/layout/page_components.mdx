---
slug: /layout/page-layout-components
id: layout_page_components
---
...
| --- | --- | --- | --- | --- |
| yes | doesn't matter | `color="plain"` | `color="plain"` |`bottomBorder={true}`
...
:::note Reminder: EuiPageTemplate can handle all these configurations for you.
