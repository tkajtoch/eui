...
export const deprecatedIcons: string[] = [
  'alert',
  'anomalyChart',
  'apmTrace',
  'arrowDown',
...
export const typeToPathMap = {
  ...
  // editorDistributeHorizontal: () => import('./assets/editor_distribute_horizontal'), // NOTE: To be deprecated in favor of distributeHorizontal
  ...
  // editorPositionBottomLeft: () => import('./assets/editor_position_bottom_left'), // NOTE: To be deprecated in favor of alignBottomLeft
  // editorPositionBottomRight: () => import('./assets/editor_position_bottom_right'), // NOTE: To be deprecated in favor of alignBottomRight
