...
describe('EuiIcon', () => {
  test('is rendered', testIcon({ type: 'accessibility', ...requiredProps }));
  ...
  describe('props', () => {
    test('onIconLoad', async () => {
      ...
      render(<EuiIcon type="accessibility" onIconLoad={onIconLoad} />);
    ...
    describe('other props', () => {
      test(
        ...
        testIcon({
          type: 'accessibility',
          'aria-label': 'An accessibility icon',
          title: 'Accessibility',
        })
      );
    });
    ...
    describe('size', () => {
      SIZES.forEach((size) => {
        test('${size} is rendered', testIcon({ type: 'accessibility', size }));
      });
    });
    ...
    describe('color', () => {
      [
        ...
        it(`${color} is rendered`, testIcon({ type: 'accessibility', color }));
      });
    });
    ...
    describe('tabIndex', () => {
      it(
        ...
        testIcon({ type: 'accessibility' })
      );

      it(
        'renders focusable="false" when -1',
        testIcon({ type: 'accessibility', tabIndex: -1 })
      );

      it(
        'renders focusable="true" when 0',
        testIcon({ type: 'accessibility', tabIndex: 0 })
      );
    });
